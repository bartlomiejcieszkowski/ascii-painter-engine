...
def test(handle_sigint=True, demo_time_s=None):
    ...
    widget = ape.ConsoleWidgets.TextBox(app=app, x=0, y=0, height=4, width=20,
                                        alignment=ape.Alignment.LeftTop)
    widget.text = 'Test'
    app.add_widget(widget)

    widget = ape.ConsoleWidgets.Pane(app=app, x=2, y=8, height=4, width=8,
                                     alignment=ape.Alignment.LeftTop)
    widget.title = 'Little Pane'
    app.add_widget(widget)

    pane = ape.ConsoleWidgets.Pane(app=app, x=11, y=8, height=5, width=40,
                                   alignment=ape.Alignment.LeftTop)
    ...
    widget = ape.ConsoleWidgets.TextBox(app=app, x=0, y=0, height=3, width=10,
                                        alignment=ape.Alignment.LeftTop)
    ...
    widget = ape.ConsoleWidgets.TextBox(app=app, x=10, y=0, height=3, width=25,
                                        alignment=ape.Alignment.LeftTop)
